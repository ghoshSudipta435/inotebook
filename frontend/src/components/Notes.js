        ...
        <>
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            ...
                            <button disabled={note.etitle.length < 5 || note.edescription.length < 5} onClick={() => {
                                handleClick();
                                props.showAlert("Updated successfully", "success");
                            }}
                                type="button" className="btn btn-primary">Update Changes</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="row my-3">
                ...
                <div className="container">
                    {/* when there is nothing on the else we use && */}
